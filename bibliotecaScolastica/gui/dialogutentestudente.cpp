...
DialogUtenteStudente::DialogUtenteStudente()
{
    createDialogUtenteStudente();
    fillDialogUtenteStudente();
}

void DialogUtenteStudente::createDialogUtenteStudente()
{
    ...
    QLabel* label11 = new QLabel("Lingua originale:", this);
    ...
    layout2->addWidget(libroNLingua, 3,1);
    layout2->addWidget(libroNDisponibilita, 4, 0, 1, 2);
    layout2->addWidget(libroNSearch, 5, 0, 1, 2);
    ...
    layoutSx->addWidget(libroSgroupbox);
    layoutSx->addWidget(libroNgroupbox);
    layoutSx->addWidget(cdgroupbox);
    ...
    connect(libroSSearch, SIGNAL(clicked()), this, SLOT(studenteLibroSSearch()));
    connect(libroNSearch, SIGNAL(clicked()), this, SLOT(studenteLibroNSearch()));
    connect(cdSearch, SIGNAL(clicked()), this, SLOT(studenteCdSearch()));
    connect(vediInfo, SIGNAL(clicked()), this, SLOT(studenteVediInfo()));

    setWindowTitle(tr("Utente studente - Ricerca articoli"));
    setFixedWidth(1100);
}

void DialogUtenteStudente::fillDialogUtenteStudente()
{
...
void DialogUtenteStudente::printArticoli(std::list<Articolo*> l) const //stampa nella QTableWidget l'articolo a
{
...
void DialogUtenteStudente::createVisualizzaInfoArticolo()
{
...
void DialogUtenteStudente::printInfoLibroN(LibroNarrativa* libroN) const
{
...
void DialogUtenteStudente::printInfoLibroS(LibroScolastico* libroS) const
{
...
void DialogUtenteStudente::printInfoCd(CdMusicale* cd) const
{
...
void DialogUtenteStudente::studenteLibroSSearch()
{
...
void DialogUtenteStudente::studenteLibroNSearch()
{
    //svuoto la QtableWidget
    showSearchResults->clearSelection();
    showSearchResults->clearContents();
    ...
    QString eta = "Tutte"; //Utente Studente non ha la ricerca per fascia d eta
...
void DialogUtenteStudente::studenteCdSearch()
{
    //svuoto la QtableWidget
    showSearchResults->clearSelection();
    showSearchResults->clearContents();
...
void DialogUtenteStudente::studenteVediInfo()
{
...
void DialogUtenteStudente::chiudiInfo()
{
